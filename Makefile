...
ARDUINO_PATH:=/home/masc/projekte/electronix/arduino/arduino-1.5.2/
...
AVR_TOOLS_PATH:=$(ARDUINO_PATH)hardware/tools/g++_arm_none_eabi/bin/
...
COMMON_FLAGS += -I$(ARDUINO_PATH)../sketchbook/libraries/UTFT
COMMON_FLAGS += -I$(ARDUINO_PATH)../sketchbook/libraries/UTouch
COMMON_FLAGS += -I$(ARDUINO_PATH)../sketchbook/libraries/I2Cdev
COMMON_FLAGS += -I$(ARDUINO_PATH)../sketchbook/libraries/BMP085
COMMON_FLAGS += -I$(ARDUINO_PATH)hardware/arduino/sam/libraries/Wire
